            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption"><i class="fa fa-edit"></i>管理用户</div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
                                    ...
                                    <td  disabled="disabled"><?php echo ($vo["uid"]); ?></td>
        ...
        return {
            ...
            init: function () {
                ...
                function editRow(oTable, nRow) {
                    ...
                    jqTds[3].innerHTML = '<select name="department" class="form-control input-small" ><option value="1">运营一部</option>  <option value="2">运营二部</option> <option value="3">运营三部</option> <option value="5">运营五部</option> <option value="6">运营六部</option><option value="7">郑州分部</option><option value="8">未分配</option><option value="9">郑州分部eBay1</option><option value="10">郑州分部eBay2</option><option value="12">郑州分部eBay3</option><option value="11">郑州分部Shopee</option></select>';
                ...
                $('#sample_editable_1 a.edit').live('click', function (e) {
                    ...
                    var uid = $(this).parents('tr').find("td:nth-child(1) input").val();
                    var username = $(this).parents('tr').find("td:nth-child(2) input").val();
                    var password = $(this).parents('tr').find("td:nth-child(3) input").val();
                    var department = $(this).parents('tr').find("option:selected").val();
