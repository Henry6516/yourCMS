...
//        }
        ...
        for ($i=2; $i<=$highestRow; ++$i) {
            ...
            //  INSERT INTO Y_devOfflineClearn (plat,suffix,saleopefeezn,saleopetime) VALUES('demo','demo','100','2017-02-20 00:00:00.000')
            if(!$res){
...
//                UPDATE Y_devOfflineClearn SET plat='test',suffix='test',saleopefeezn='5',saleopetime='2017-02-18 00:00:00.000' WHERE suffix='' AND saleopetime=''
